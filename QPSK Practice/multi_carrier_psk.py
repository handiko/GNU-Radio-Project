...
class multi_carrier_psk(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Multi Carrier Psk")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Multi Carrier Psk")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "multi_carrier_psk")
        ...
        self.rrc = rrc = firdes.root_raised_cosine(nfilts, nfilts, 1.0/float(sps), 0.35, 11*sps*nfilts)
          
        self.phase_bw = phase_bw = 6.28/100.0
        self.pcs_taps = pcs_taps = rrc_taps
        ...
        self.digital_pfb_clock_sync_xxx_0_1_0 = digital.pfb_clock_sync_ccf(sps, timing_loop_bw, (pcs_taps), nfilts, nfilts/2.0, 1.5, 2)
        ...
        self.digital_cma_equalizer_cc_0_1_0 = digital.cma_equalizer_cc(15, 1, eq_gain, 2)
        self.digital_cma_equalizer_cc_0_1 = digital.cma_equalizer_cc(15, 1, eq_gain, 2)
        ...
        self.connect((self.blocks_stream_to_streams_0, 1), (self.digital_constellation_modulator_0_0, 0))    
        self.connect((self.blocks_stream_to_streams_0, 2), (self.digital_constellation_modulator_0_0_0, 0))    
        self.connect((self.blocks_stream_to_streams_0, 3), (self.digital_constellation_modulator_0_0_1, 0))    
        ...
        self.connect((self.channels_channel_model_0_0_0, 0), (self.digital_pfb_clock_sync_xxx_0_1_0, 0))    
        self.connect((self.channels_channel_model_0_1, 0), (self.digital_pfb_clock_sync_xxx_0_1, 0))    
        self.connect((self.digital_cma_equalizer_cc_0, 0), (self.digital_costas_loop_cc_0, 0))    
        self.connect((self.digital_cma_equalizer_cc_0_0, 0), (self.digital_costas_loop_cc_0_0, 0))    
        self.connect((self.digital_cma_equalizer_cc_0_1, 0), (self.digital_costas_loop_cc_0_1, 0))    
        self.connect((self.digital_cma_equalizer_cc_0_1_0, 0), (self.digital_costas_loop_cc_0_1_0, 0))    
        ...
        self.connect((self.digital_constellation_modulator_0_0, 0), (self.qtgui_time_sink_x_0, 1))    
        self.connect((self.digital_constellation_modulator_0_0_0, 0), (self.channels_channel_model_0_1, 0))    
        self.connect((self.digital_constellation_modulator_0_0_0, 0), (self.qtgui_const_sink_x_0, 2))    
        self.connect((self.digital_constellation_modulator_0_0_0, 0), (self.qtgui_time_sink_x_0, 2))    
        self.connect((self.digital_constellation_modulator_0_0_1, 0), (self.channels_channel_model_0_0_0, 0))    
        self.connect((self.digital_constellation_modulator_0_0_1, 0), (self.qtgui_const_sink_x_0, 3))    
        self.connect((self.digital_constellation_modulator_0_0_1, 0), (self.qtgui_time_sink_x_0, 3))    
        ...
        self.connect((self.digital_costas_loop_cc_0_1, 0), (self.qtgui_const_sink_x_0_0, 2))    
        self.connect((self.digital_costas_loop_cc_0_1_0, 0), (self.qtgui_const_sink_x_0_0, 3))    
        self.connect((self.digital_pfb_clock_sync_xxx_0, 0), (self.digital_cma_equalizer_cc_0, 0))    
        self.connect((self.digital_pfb_clock_sync_xxx_0_0, 0), (self.digital_cma_equalizer_cc_0_0, 0))    
        self.connect((self.digital_pfb_clock_sync_xxx_0_1, 0), (self.digital_cma_equalizer_cc_0_1, 0))    
        self.connect((self.digital_pfb_clock_sync_xxx_0_1_0, 0), (self.digital_cma_equalizer_cc_0_1_0, 0))    
    ...
    def set_timing_loop_bw(self, timing_loop_bw):
        ...
        self.digital_pfb_clock_sync_xxx_0_1_0.set_loop_bandwidth(self.timing_loop_bw)
    ...
    def set_taps(self, taps):
        ...
        self.channels_channel_model_0_0_0.set_taps((self.taps))
    ...
    def get_pcs_taps(self):
        return self.pcs_taps

    def set_pcs_taps(self, pcs_taps):
        self.pcs_taps = pcs_taps
        self.digital_pfb_clock_sync_xxx_0_1_0.update_taps((self.pcs_taps))
        self.digital_pfb_clock_sync_xxx_0_1.update_taps((self.pcs_taps))
        self.digital_pfb_clock_sync_xxx_0_0.update_taps((self.pcs_taps))
        self.digital_pfb_clock_sync_xxx_0.update_taps((self.pcs_taps))
    ...
    def set_eq_gain(self, eq_gain):
        ...
        self.digital_cma_equalizer_cc_0_1_0.set_gain(self.eq_gain)
        self.digital_cma_equalizer_cc_0_1.set_gain(self.eq_gain)
