...
class Chunk_to_Symbols_vs_Constel_Mod(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Chunk-to-Symbols vs Constel Mod")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Chunk-to-Symbols vs Constel Mod")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "Chunk_to_Symbols_vs_Constel_Mod")
        ...
        self.digital_map_bb_0 = digital.map_bb((Const_PLD.pre_diff_code()))
        ...
        self.digital_chunks_to_symbols_xx_0 = digital.chunks_to_symbols_bc((Const_PLD.points()), 1)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, samp_rate,True)
        self.blocks_repeat_0 = blocks.repeat(gr.sizeof_gr_complex*1, 4)
        self.blocks_repack_bits_bb_0 = blocks.repack_bits_bb(8, Const_PLD.bits_per_symbol(), "", False, gr.GR_LSB_FIRST)
        ...
        self.connect((self.digital_constellation_modulator_0, 0), (self.qtgui_const_sink_x_0, 1))    
        self.connect((self.digital_constellation_modulator_0, 0), (self.qtgui_time_sink_x_0, 1))    
...
def main(top_block_cls=Chunk_to_Symbols_vs_Constel_Mod, options=None):
